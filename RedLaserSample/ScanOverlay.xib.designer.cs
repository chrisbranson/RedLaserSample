...
namespace RedLaserSample {
	...
	public partial class OverlayController {
		...
		private MonoTouch.UIKit.UIView __mt_cameraView;
		...
		[MonoTouch.Foundation.Connect("cameraView")]
		private MonoTouch.UIKit.UIView cameraView {
			get {
				this.__mt_cameraView = ((MonoTouch.UIKit.UIView)(this.GetNativeField("cameraView")));
				return this.__mt_cameraView;
			}
			set {
				this.__mt_cameraView = value;
				this.SetNativeField("cameraView", value);
			}
		}
